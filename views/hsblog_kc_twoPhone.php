...
?>
      ...
      <div class="mock-ups">
        ...
        <div class="mock-up mock-up--rotate-left" style="width: 231.74px; height: 451.27px;">
          <div class="mock-up__skeleton" style="background-image:url(<?php echo esc_attr($atts['skeleton_1']); ?>)"></div>
        ...
        <div class="mock-up mock-up--rotate-right" style="width: 269px; height: 523px;">
          <div class="mock-up__skeleton" style="background-image:url(<?php echo esc_attr($atts['skeleton_2']); ?>)"></div>
